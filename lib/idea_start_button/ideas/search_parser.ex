defmodule IdeaStartButton.Ideas.SearchParser do
  ...
  ## Examples
      ...
      iex> IdeaStartButton.Ideas.SearchParser.parse("@alice elixir programming")
      %{keywords: ["elixir", "programming"], authors: ["alice"]}

      iex> IdeaStartButton.Ideas.SearchParser.parse("ruby @alice  @bob")
