defmodule IdeePlace.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_name(changeset) do
    ...
    |> unsafe_validate_unique(:name, IdeePlace.Repo)
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, IdeePlace.Repo)
  ...
  """
  def valid_password?(%IdeePlace.Accounts.User{hashed_password: hashed_password}, password)
